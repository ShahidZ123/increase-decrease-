...
function resetHandler() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] flex justify-center items-center flex-col bg-[#344151] gap-10 ">
      <div className="text-[#0398d4] font-midium text-2xl">Increment & decrement</div>
      <div className="bg-white flex justify-center py-3 rounded-sm gap-12 text-[25px] text-[#344151]">
